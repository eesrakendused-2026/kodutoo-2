...
Kõik nõuded täidetud, siis 30 punkti.
    ...
    Rakenda 4 erinevat heliklippi mängu jooksul - alguse jaoks, mängu jooksul, lõpus ja kui tulemus jõuab edetabelisse.
    Lisa omaltpoolt veel 3 feature, mida hetkel rakenduses pole.

GitHub'i töövoog kodutöö esitamiseks

    Fork'i ülesande/projekti repositoorium (leiab https://github.com/eesrakendused-2026/).
